...
const WorkAI = ({ deepseek, qrcode, analysed }) => {
 ...
 // Convert whatever you got into a string ALWAYS
const safeMarkdown =
  typeof deep === "string"
    ? deep
    : deep
  ...
  return (
    <div className=' w-[88%]  px-4 py-8 p-3 rounded-2xl ' >
      <div className='w-[100%] max-h-137 overflow-y-auto bg-slate-700  border rounded-2xl'>
        {/* {qrcode==="photo" ?(
          <>
         ...
         <div className='px-3 my-3'> 
          ...
          qrcode === "photo" ? (
            <>
              ...
              {/* Exportable content */}
              <div ref={contentRef} className=" p-4 px-3 my-3">
                <article className="prose max-w-none">
                  <ReactMarkdown>{safeMarkdown ? safeMarkdown : "No Analysis"}</ReactMarkdown>
                </article>
              </div>
